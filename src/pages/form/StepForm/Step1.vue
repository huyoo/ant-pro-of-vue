  ...
  <div>
    <a-form :form="form" style="max-width: 500px; margin: 40px auto 0;">
      <a-form-item label="付款账户"
        ...
        <a-select v-decorator="['paymentUser', {
        rules: [{required: true, message: '付款账户必须填写'}],
        initialValue: paymentUser
        }]">
      ...
      <a-form-item label="收款账户"
        ...
        <a-input-group style="display: inline-block; vertical-align: middle" :compact="true">
          <a-select :defaultValue="payType" style="width: 100px">
      ...
      <a-form-item
        ...
        :wrapperCol="wrapperCol"
      >
        <a-input prefix="￥" v-decorator="['money', {
        initialValue: money,
...
<script>
	...
	export default {
		name: "Step1",
		components: {AInputGroup, AFormItem},
		data() {
			return {
